...
class FilterHelper
{
	...
	protected function decodeFilterASCII85Decode(string $data): string
	{
		...
		// z sequence
		$zseq = FilterHelper.php\chr(0).\chr(0).\chr(0).\chr(0);
		...
		switch ($group_pos) {
			case 4:
				$decoded .= FilterHelper.php\chr($tuple >> 24).\chr($tuple >> 16).\chr($tuple >> 8);
				break;

			case 3:
				$decoded .= FilterHelper.php\chr($tuple >> 24).\chr($tuple >> 16);
				break;
